...
MAKECMD         = /Applications/MATLAB_R2025b.app/bin/maca64/gmake -j 4 -l 8
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODULES                 = OrganizedModel.c OrganizedModel_capi.c OrganizedModel_data.c OrganizedModel_tgtconn.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c main.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = OrganizedModel
MAKEFILE                = OrganizedModel.mk
MATLAB_ROOT             = /Applications/MATLAB_R2025b.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2025b.app
START_DIR               = /Users/khalidwaleed/Desktop/Bachelor/Regenerative-Suspension-Bachelor/Models/CascadedSystem
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 6
COMPUTER                = MACA64
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/OrganizedModel \
